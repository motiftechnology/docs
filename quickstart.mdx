...
- A ChaterAfrika account (sign up or contact [support@chaterafrika.com](mailto:support@chaterafrika.com))
...
For **testing** (beta): `npm install @chaterafrikang/sdk@beta`
...
const client = new ChatAfrika({
  wsUrl: 'wss://ws.dev.chaterafrika.com/ws',
  apiUrl: 'https://dev.chaterafrika.com/api/v1',
  token
});
await client.connect();
...
```bash
curl -X POST https://dev.chaterafrika.com/api/v1/auth/login \
...
```bash
# Get conversations
curl https://dev.chaterafrika.com/api/v1/conversations \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"

# Get messages for a conversation
curl https://dev.chaterafrika.com/api/v1/conversations/{conversationId}/messages \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
