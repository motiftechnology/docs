...
```typescript
import { ChatAfrika, Conversation, Message } from '@chaterafrikang/sdk';
...
import { ChatAfrika, Conversation, Message, ConnectionState } from '@chaterafrikang/sdk';
...
```typescript
import { ChatAfrika, SupportSession } from '@chaterafrikang/sdk';
