...
Issue a short-lived SDK token for an external user. Use this token in your frontend with the ChatAfrika SDK or WebSocket connection. **Your backend** calls this endpoint; the **frontend** never sees App ID, public key, or secret key—only the token.
...
<CardGroup cols={2}>
  ...
  <Card title="Create Conversation" icon="comments" href="/api-reference/conversations/create">
