...
```bash
curl -X GET "https://dev.chaterafrika.com/api/v1/sdk/conversations/770e8400-e29b-41d4-a716-446655440002/messages?limit=20" \
...
```bash
curl -X GET "https://dev.chaterafrika.com/api/v1/sdk/conversations/770e8400-e29b-41d4-a716-446655440002/messages?external_user_id=user_123&limit=20" \
...
```bash
curl -X GET "https://dev.chaterafrika.com/api/v1/sdk/conversations/770e8400.../messages?external_user_id=user_123&cursor=2024-01-01T10:00:00.000Z&limit=20" \
  -H "X-Api-Key: pk_xxxxx" \
  -H "X-Api-Secret: sk_xxxxx"
```
